...
const features = [
  {
    ...
    placeholder:
      "e.g. Built a landing page with React, integrated Stripe payments, deployed to Vercel. 3 rounds of revisions. Took about 20 hours.",
  },
  {
    id: "email",
    title: "Invoice Email",
    ...
    icon: RiMailLine,
    placeholder:
      "e.g. Sending invoice to Jane at Acme Corp for $5,500 web design project. Due in 14 days.",
  },
  {
    id: "reminder",
    ...
    icon: RiBellLine,
    placeholder:
      "e.g. Invoice INV-2026-001 for $3,200 is 7 days overdue. Client is Acme Corp, contact is john@acme.com.",
  },
  {
    id: "terms",
    title: "Payment Terms",
    ...
    placeholder:
      "e.g. Freelance design agency, projects typically $2k-$20k, international clients, want to protect against late payments.",
  },
];
    ...
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-white/40 text-sm">
          Generate professional invoice content with AI
        </p>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
        {features.map((f) => {
          ...
          return (
            ...
            >
              <Icon
                className={`w-5 h-5 mb-2.5 ${selected === f.id ? "text-[#FF0A54]" : "text-white/40"}`}
              />
              <p
                className={`text-sm font-semibold ${selected === f.id ? "text-white" : "text-white/70"}`}
              >
                {f.title}
              </p>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="bg-[#0a0a0a] border border-white/8 rounded-xl p-5 space-y-4">
          ...
          <div>
            <Label htmlFor="ai-input" className="text-white/40 text-xs">
        ...
        <div className="bg-[#0a0a0a] border border-white/8 rounded-xl p-5 space-y-4">
          ...
          <div
            className={`min-h-48 p-4 rounded-lg border text-sm whitespace-pre-wrap leading-relaxed ${
              output
                ? "bg-[#111] border-white/8 text-white"
